...
const printGoals = function (...playerNames) {
  for (let x = 0; x < playerNames.length; x++) {
    console.log(playerNames[x]);
  }
  console.log(`Which makes a total of ${playerNames.length} goals scored.`);
};
...
team1 < team2 && console.log('Team 1 is gonna kill it!');
team1 > team2 && console.log('Team 2 is gonna kill it!');
